...
int main()
{
    ...
    printLists("6 new elemens:", list1, list2);
    ...
    //delete second element and elemens after element with value 99
    ...
    list2 =list1;
    list2.unique();
    printLists("sorted and quique:", list1, list2);

    //merge both sorted lists to list1
    list1.merge(list2);
